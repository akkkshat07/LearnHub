...
if(empty($_SESSION['un'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM tbl_notes_details WHERE subject = ?");
        ...
        <div class="wrapper">
            <div class="main">
                <div class="clear">
                    <div class="topic">
                        <?php
                        // Loop through the results and display topics
                        while($row = $result->fetch_object()) {
                            echo "<ul><li><a href='elearing_topic.php?notes_id=$row->notes_id' target='subject_content'>$row->topic</a></li></ul>";
                        }
                        ?>
                    </div>

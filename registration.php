...
function validateEmail(input) {
    ...
    const somaiyaEmailPattern = /^[a-zA-Z0-9._%+-]+@somaiya\.edu$/;

    if (!somaiyaEmailPattern.test(email)) {
        input.setCustomValidity("Please enter a valid email address ending with @somaiya.edu.");
    } else {
	  ...
	  table
	  {
	  	background:url(web/images/reg_bckg.jpg) no-repeat ;
		border-radius:30px;
...
<div class="wrapper">
<div class="logo">
	<a href="home.php"><h1>LearnHub</h1></a>
</div>
...
<form action="store.php" method="post" enctype="multipart/form-data">
 <table id="reg" width="71%" height="562" border="0" cellpadding="2" cellspacing="2" rules="rows">
                   ...
                   <tr>
                     ...
                     <td><input type="text" name="dob" placeholder="DD/MM/YYYY" required="required" pattern="(0[1-9]|[12][0-9]|3[01])/(0[1-9]|1[012])/\d{4}" title="Please enter a valid date of birth in the format DD/MM/YYYY." /></td>
                   ...
                   <tr>
                     ...
                     <td><input name="phno" type="text" size="25" placeholder="MOBILE NUMBER" required="required" pattern="[789][0-9]{9}" title="Please enter a valid 10-digit mobile number starting with 7, 8, or 9." /></td>
                   ...
                   <tr>
                     ...
                     <td><input type="email" name="email" placeholder="EMAIL ADDRESS" required="required" pattern="[a-zA-Z0-9._%+-]+@somaiya\.edu$" title="Please enter a valid email address ending with @somaiya.edu." oninput="validateEmail(this)" /></td>
